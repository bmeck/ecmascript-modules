...
function setupResources() {
  global.Blob = NativeModule.require('internal/blob').Blob;
  global.Response = NativeModule.require('internal/response').Response;
  global.MIME = NativeModule.require('internal/mime').MIME;
}
