...
class Worker extends EventEmitter {
  constructor(filename, options = {}) {
    ...
    const internal = new.target === InternalWorker;
    if (!internal && !options.eval) {
    ...
    this[kPort].postMessage({
      ...
      internal,
      loaderModules: internal ? options.loaderModules :  getOptionValue('--loader')
    }, [port2]);
...
// prevent mutation from using getter/setters
InternalWorker.prototype.constructor = Worker;
Object.freeze(InternalWorker.prototype);
// freezes the super constructor
Object.freeze(InternalWorker);
