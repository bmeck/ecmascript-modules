...
const { Response, deserializeResponse, RESPONSE_DATA } = require('internal/response');
const {
  MessageChannel,
...
exports.resolvedToResponse = async (resolved) => {
  if (resolved.type === 'builtin') {
    ...
    // this is not synthetic, host says it has a specific url
    RESPONSE_DATA.get(response).url_list = [url.href];
    return response;
